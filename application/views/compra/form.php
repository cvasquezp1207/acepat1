		...
		<div class="ibox">
			<div class="ibox-title">
				...
				<div class="ibox-tools">
					<button type="button" id="buscar-pedido" class="btn btn-xs btn-info"><i class="fa fa-search"></i> Buscar pedidos</button>
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="serie" id="serie" value="<?php echo (!empty($compra["serie"])) ? $compra["serie"] : ""; ?>" class="form-control input-xs" maxlength="4" required="">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label class="required">Numero</label>
								<input type="text" name="numero" id="numero" value="<?php echo (!empty($compra["numero"])) ? $compra["numero"] : ""; ?>" class="form-control input-xs" maxlength="8" required="">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label class="required">Fecha compra</label>
								<input type="text" name="fecha_compra" id="fecha_compra" value="<?php echo (!empty($compra["fecha_compra"])) ? dateFormat($compra["fecha_compra"], "d/m/Y") : date("d/m/Y"); ?>" class="form-control input-xs" placeholder="<?php echo date("d/m/Y"); ?>" required="">
							</div>
						</div>
					</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="input-group">
									<input type="text" name="proveedor" id="proveedor_descripcion" value="<?php echo (!empty($proveedor["nombre"])) ? $proveedor["nombre"] : ""; ?>" class="form-control input-xs" placeholder="Razon social o RUC" required="">
									<span class="input-group-btn tooltip-demo">
										<button type="button" id="btn-buscar-proveedor" class="btn btn-outline btn-primary btn-xs" data-toggle="tooltip" title="Buscar proveedores">
											<i class="fa fa-search"></i>
										</button>
										<button type="button" id="btn-registrar-proveedor" class="btn btn-outline btn-primary btn-xs" data-toggle="tooltip" title="&iquest;No existe el proveedor? Registrar aqui">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="cambio_moneda" id="cambio_moneda" value="<?php echo (!empty($compra["cambio_moneda"])) ? $compra["cambio_moneda"] : ""; ?>" class="form-control input-xs numero">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label style="display:block;">Conversi&oacute;n</label>
								<label class="radio-inline"><input type="radio" name="conversion" value="M"> Mult</label>
								<label class="radio-inline"><input type="radio" name="conversion" value="D"> Div</label>
								<span class="checkbox-inline"><button type="button" id="btn-convertir" class="btn btn-xs btn-white" title="Clic para convertir" data-toggle="tooltip"><i class="fa fa-money"></i></button></span>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<label>Tipo descuento</label>
								<?php echo $tipodescuento; ?>
							</div>
						</div>
					</div>
				</form>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" name="nroguias" id="nroguias" value="<?php echo (!empty($compra["nroguias"])) ? $compra["nroguias"] : ""; ?>" class="form-control input-xs">
							</div>
						</div>
					</div>
				</form>
			...
			<div class="ibox-content">
				<form aria-control="<?php echo $controller; ?>" class="app-form form-uppercase">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group">
								<label class="required">Total <span class="abrev-moneda"></span></label>
						...
						<div class="form-group">
							<div class="col-sm-2 col-sm-offset-10">
								<div class="form-group">
									...
									<input type="text" name="equivalencia" id="equivalencia" value="<?php echo (!empty($compra["equivalencia"])) ? $compra["equivalencia"] : ""; ?>" class="form-control input-xs numero" readonly="">
								</div>
							</div>
						</div>
					</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						<div class="input-group"><input id="input-text-serie" placeholder="Ingrese la series" class="input-sm form-control text-uppercase" type="text" 			/>
					<!--	<div class="input-group"><input id="input-text-serie" placeholder="Modelo" class="input-sm form-control text-uppercase" type="text" />-->
