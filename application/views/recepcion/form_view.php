	...
	<div class="col-sm-4">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" value="<?php echo $compra["tipo_documento"]." ".$compra["nrodocumento"]; ?>" class="input-sm form-control" readonly>
				</div>
			</div>
		</form>
	</div>
	...
	<div class="col-sm-8">
		<form class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" value="<?php echo $compra["proveedor"]; ?>" class="input-sm form-control" readonly>
				</div>
			</div>
		</form>
	</div>
...
<div class="project-list">
	<table class="table table-hover table-recepcion">
		<tbody>
		<?php
		if( ! empty($detalle)) {
			foreach($detalle as $k=>$val) {
				...
				echo '<button class="btn-white btn btn-sm btn_del" data-toggle="tooltip" title="Eliminar recepcion" data-idrecepcion="'.$val["idrecepcion"].'"><i class="fa fa-trash"></i></button>';
				echo '</div></td>';
				echo '</tr>';
			}
		}
