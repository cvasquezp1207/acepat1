				...
				<table id="tabla_unidad_medida" class="tabla_modulos table table-striped">
					<thead>
						<tr>
							<th>Unidad medida</th>
							<th>Cantidad</th>
							<th class="tooltip-demo">Equivalencia (<a id="ref_unidad_medida" data-toggle="tooltip" title="<?php echo (isset($unidad["descripcion"])) ? $unidad["descripcion"]:""; ?>"><?php echo (isset($unidad["descripcion"])) ? $unidad["abreviatura"]:""; ?></a>)</th>
							<th>&nbsp;</th>
						</tr>
					</thead>
					<tbody>
...
<script>
UNIDAD_MEDIDA = <?php echo json_encode($unidades); ?>;
</script>