<form id="form_<?php echo $controller; ?>" class="app-form">
	...
	<div class="row">
		<div class="col-md-2">
			...
			<div class="form-group">
            <label for="idmodalidad"  class="required col-sm-12" id="idmodalidad">Modalidad Venta:</label>
            <div class="col-sm-12"><?php echo $modalidad; ?></div> 
            <label for="idrampa" class="required idrampa col-sm-12 control-label" style="display:none">Rampa:</label>
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="subtotal" id="subtotal" value="<?php echo (!empty($preventa["subtotal"])) ? $preventa["subtotal"] : ""; ?>" class="form-control numero" required="" readonly="">
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="form-group">
								...
								<input type="text" name="total" id="total" value="<?php echo (!empty($preventa["total"])) ? $preventa["total"] : ""; ?>" class="form-control numero" required="" readonly="">
							</div>
						</div>
					</div>
