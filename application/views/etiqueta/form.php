<form id="form_<?php echo $controller; ?>" class="form-horizontal app-form form-uppercase">
	...
	<div class="form-group">
		<label class="col-lg-3 control-label required">Label Impresion</label>
		<div class="col-lg-9">
			<input type="text" name="label_impresion" id="<?php echo $prefix; ?>label_impresion" value="<?php echo (!empty($label_impresion)) ? $label_impresion : ""; ?>" class="form-control" required="">
		</div>
	</div>
	<div class="form-group">
		<label class="col-lg-3 control-label">Etiqueta</label>
		<div class="col-lg-9">
			<input type="text" name="etiqueta" id="<?php echo $prefix; ?>etiqueta" value="<?php echo (!empty($etiqueta)) ? $etiqueta : ""; ?>" class="form-control">
		</div>
	</div>
	<div class="form-group">
