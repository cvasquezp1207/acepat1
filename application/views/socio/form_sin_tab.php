	        ...
	        <div class="row" style="">
	            <div class="col-md-5">
					<div class="ibox float-e-margins" style="background: white;">
						...
						<div class="ibox-content ibox-temp">
												...
												<div class="row" style="">
													<div class="col-md-7">
														<div class="">
															...
															<input type="text" class="form-control nombres here_req req input-xs" placeholder="Nombres" value="<?php  echo (!empty($nombres)) ? $nombres : "" ?>" ></input>
															<!--<br>-->
														...
														<div class="">
															...
															<input type="text" name="apellidos" class="form-control apellidos input-xs here_req req" placeholder="Apellidos" value="<?php  echo (!empty($apellidos)) ? $apellidos : "" ?>" ></input>
															<!--<br>-->
															<div class="separation"></div>
														</div>
														...
														<div class="">
															...
															<div class="input-group email">
																...
																<input type="text" class="form-control cliente_email input-xs" value="<?php  echo (!empty($cliente_email)) ? $cliente_email : "" ?>">
															</div>
															<!--<br>-->
															<div class="separation"></div>
														</div>
										...
										<div class="row" style="">
											...
											<div class="col-md-5">
												<div class="">
													...
													<select class="form-control input-xs here_req req" name="sexo" id="<?php echo $prefix; ?>sexo">
										...
										<div class="row" style="">
											<div class="col-md-5">
												<div class="">
													...
													<div class="input-group date">
												       	<span class="input-group-addon" style="font-size:10px;"><i style="height:10px;" class="fa fa-calendar"></i></span>
												       	<input name="fecha_nac" id="<?php echo $prefix; ?>fecha_nac" type="text" class="form-control input-xs fecha_nac here_req req" value="<?php  echo (!empty($fecha_nac)) ? dateFormat($fecha_nac,"d/m/Y") : "" ?>" />
													</div>
													<br>
												</div>
											</div>
											...
											<div class="col-md-3">
												<div class="">
													...
													<input name="dni" class="form-control dni here_req req input-xs" maxlength=8 value="<?php  echo (!empty($dni)) ? $dni : "" ?>"></input>
												</div>
												<br>
											</div>
											...
											<div class="col-md-4">
												<div class="">
													...
													<input type="text" class="form-control ruc input-xs" maxlength=11 value="<?php  echo (!empty($ruc)) ? $ruc : "" ?>"></input>
												</div>
												<br>
											</div>
										</div>
													...
													<div class="col-md-12">
														...
														<div class="input-group">
															...
															<span class="input-group-btn tooltip-demo">
																<button type="button" id="btn-registrar-zona" style="font-size:8px;" class="btn btn-outline btn-success " data-toggle="tooltip" title="&iquest;No existe la zona? Registrar aqui">
															...
															<?php
																...
																if(!empty($direcciones)){
																	foreach($direcciones as $key=>$val){
																		...
																		$html_dir.='	</span>';
																		$html_dir.='	<input type="text" name="direccion[]" placeholder="Direccion..." value="'.$val['direccion'].'" class="form-control direccion here_req req" required="">';
																	...
																	$html_dir.='	</span>';
																	$html_dir.='	</span>';
																	$html_dir.='	<input type="text" name="direccion[]" placeholder="Direccion..." class="form-control direccion here_req req" required="">';
												...
												<div class="row" style="">
													<div class="col-md-6">
														...
														<div class="input-group">
															...
															<span class="input-group-btn tooltip-demo">
																<button type="button" id="btn-registrar-ocupacion" class="btn btn-outline btn-success" style='font-size:8px;' data-toggle="tooltip" title="&iquest;No existe el Cargo/Ocupacion? Registrar aqui">
																	<i class="fa fa-edit"></i>
																</button>
															</span>
														</div>
...
<style>
	...
	.ibox-temp{background: transparent;}
	...
	.form_clientito input,.form_clientito select{font-size:10px;}
  </style>