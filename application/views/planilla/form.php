							...
							<form id="parametros">
								<table class="table table-striped">
									<tr>
										...
										<td width="">
											<input type="text" name="fechainicio" id="fechainicio" class="form-control input-xs" value="<?php echo date('d/m/Y'); ?>"   placeholder="m/Y" >
										</td>
									...
									<tr>
										<td><div id="">Estado Credito</div></td>
										<td colspan=2>
									...
									<tr>
										<td colspan=3>
											...
											<center>
												...
												<button id="ver-carta" class="btn btn-primary btn-sm" type="button"> <i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Carta &nbsp;&nbsp;&nbsp;&nbsp;</button>
												<!--
												-->
											</center>
										</td>
