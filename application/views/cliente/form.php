								...
								<div class="row" style="">
									<div class="col-md-8">										
										...
										<div class="form-group" style="margin-right:0px;margin-left:0px;">
											...
											<input type="text" name="nombres" class="form-control nombres here_req req" id="<?php echo $prefix; ?>nombres" placeholder="Nombres/ Razon social" value="<?php  echo (!empty($nombres)) ? $nombres : "" ?>" ></input>
							...
							<fieldset class="">
								...
								<div class="form-group" style="margin-right:0px;margin-left:0px;">
									<!--<div class="info_natural" style="display:block;">-->
										...
										<div class="row" style="">
											<div class="col-md-6">
												<label class="">Tipo de Tienda</label>
												<div class="input-group">
													<?php echo $ocupacion_cli;?>
													<span class="input-group-btn tooltip-demo">
														<button type="button" id="btn-registrar-ocupacion" class="btn btn-outline btn-success btn-xs" data-toggle="tooltip" title="&iquest;No existe la clasificacion? Registrar aqui">
															<i class="fa fa-edit"></i>
														</button>
													</span>
												</div>
...
<div id="modal-ocupacion" class="modal fade" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Registrar Clasificacion de cliente</h4>
			</div>
			<div class="modal-body">
				<div class="row">
