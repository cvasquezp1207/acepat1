...
class Reportereciboingresos extends Controller {
	/**
	...
	public function dataresumido(){
		$sql = "SELECT reciboingreso_view.*, to_char(fecha,'DD/MM/YYYY') fecha_rec 
				FROM venta.reciboingreso_view
				WHERE estado='A'
	...
	public function resumido(){
		...
		$cabecera = array('recibo'=> array('RECIBO',$whit_min)
							,'fecha_rec' => array('FECHA',$whit_fecha)
