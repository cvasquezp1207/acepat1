...
class Tipo_compra extends Controller {
	
	/**
	 * Datos iniciales del controlador
	 */
	public function init_controller() {
		$this->set_title("Mantenimiento de Tipo Compra");
		$this->set_subtitle("Lista de Tipos de Compra");
	}
	...
	public function grilla() {
		...
		$this->datatables->setModel($this->tipo_compra);
	...
	public function nuevo() {
		$this->set_title("Registrar Tipo Compra");
		$this->set_subtitle("");
	...
	public function editar($id) {
		$this->load_model($this->controller);
		$data = $this->tipo_compra->find($id);
		
		$this->set_title("Modificar Tipo Compra");
		$this->set_subtitle("");
	...
	public function guardar() {
		...
		$fields['estado'] = "A";
		if(empty($fields["idtipocompra"])) {
			$this->tipo_compra->insert($fields);
		}
		else {
			$this->tipo_compra->update($fields);
		}
		
		$this->response($this->tipo_compra->get_fields());
	}
