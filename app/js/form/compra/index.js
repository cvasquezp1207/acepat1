...
function verificarRecepcionados(nRow, aData, iDisplayIndex) {
	...
	// }
	$("td:eq(1)",nRow).html(aData.fecha_compra_es);
	$('td:eq(6)', nRow).html("<div style='text-align:right;'>"+aData['subtotal']+"</div>");
	$('td:eq(7)', nRow).html("<div style='text-align:right;'>"+aData['igv']+"</div>");
	$('td:eq(8)', nRow).html("<div style='text-align:right;'>"+aData['descuento']+"</div>");
