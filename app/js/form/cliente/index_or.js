...
$("#addTelefono").on('click',function(){
	if( $('.telefono').required() ){
		...
		$html_telf+='		<button type="button" style="height: 30px;" class="btn btn-outline btn-success delete_telefono" data-toggle="tooltip" title="Borrar Telefono">';
...
$("#addRepresentante").on('click',function(){
    ...
    $html_rep+='      <div class="">';
		$html_rep+='			<label >Nombres</label>';
		$html_rep+='				<input type="text" name="nombre_representante[]" value="" placeholder="Nombre Representante" class="form-control nombre_representante ">';
		$html_rep+='			</div>';
		$html_rep+='		</div>';
